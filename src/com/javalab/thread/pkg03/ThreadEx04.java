 ...
 * 실행클래스
 */
public class ThreadEx04 { // class s

	public static void main(String[] args) throws InterruptedException { // main s
...
class ThreadEx4_1 extends Thread {
	public void run() {
		for (int i = 0; i < 5; i++) {
			try {
				sleep(1000);	// sleep은 static 메소드  // 1초동안 스레드 대기상태
